...
public class EdgeMistouchSettings {

    public static final String NODE = "/proc/touchpanel/oplus_tp_limit_enable";
    public static final String KEY = "edge_mistouch_enable";
